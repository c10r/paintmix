(function (root, factory) {
  ...
  collect$ObjectLiteral_12.$metadata$ = {kind: Kind_CLASS, interfaces: [FlowCollector]};
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$$receiver.collect_42ocv1$(new collect$ObjectLiteral_12(toCollection$lambda(this.local$destination)), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  collect$ObjectLiteral_13.$metadata$ = {kind: Kind_CLASS, interfaces: [FlowCollector]};
  ...
  Coroutine$count_1.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
      ...
      try {
        switch (this.state_0) {
          case 0:
            this.local$i = {v: 0};
            this.state_0 = 2;
            this.result_0 = this.local$$receiver.collect_42ocv1$(new collect$ObjectLiteral_13(count$lambda(this.local$i)), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function count_2($receiver_0, continuation_0, suspended) {
  ...
  package$flow.count_x2ftfk$ = count_2;
